...
export class Graphic {
        ...
        for (const param of params) {
            switch (param) {
                ...
                case 25:
                    attr &= ~CGA.BLINK
                    break
                case 30: attr = (attr & 0xf8) | CGA.BLACK; break
                case 31: attr = (attr & 0xf8) | CGA.RED; break
                case 32: attr = (attr & 0xf8) | CGA.GREEN; break
                case 33: attr = (attr & 0xf8) | CGA.BROWN; break
                case 34: attr = (attr & 0xf8) | CGA.BLUE; break
                case 35: attr = (attr & 0xf8) | CGA.MAGENTA; break
                case 36: attr = (attr & 0xf8) | CGA.CYAN; break
                case 37: attr = (attr & 0xf8) | CGA.LIGHTGRAY; break
                case 90: attr = (attr & 0xf0) | CGA.DARKGRAY; break
                case 91: attr = (attr & 0xf0) | CGA.LIGHTRED; break
                case 92: attr = (attr & 0xf0) | CGA.LIGHTGREEN; break
                case 93: attr = (attr & 0xf0) | CGA.YELLOW; break
                case 94: attr = (attr & 0xf0) | CGA.LIGHTBLUE; break
                case 95: attr = (attr & 0xf0) | CGA.LIGHTMAGENTA; break
                case 96: attr = (attr & 0xf0) | CGA.LIGHTCYAN; break
                case 97: attr = (attr & 0xf0) | CGA.WHITE; break
                case 40: attr = (attr & 0x8f) | CGA.BG_BLACK; break
                case 41: attr = (attr & 0x8f) | CGA.BG_RED; break
                case 42: attr = (attr & 0x8f) | CGA.BG_GREEN; break
                case 43: attr = (attr & 0x8f) | CGA.BG_BROWN; break
                case 44: attr = (attr & 0x8f) | CGA.BG_BLUE; break
                case 45: attr = (attr & 0x8f) | CGA.BG_MAGENTA; break
                case 46: attr = (attr & 0x8f) | CGA.BG_CYAN; break
                case 47: attr = (attr & 0x8f) | CGA.BG_LIGHTGRAY; break
            }
        }
    ...
    private ctrlASequence(attr: number, curAttr: number): string {
        ...
        if (((curAttr & CGA.BLINK) && !(attr & CGA.BLINK)) ||
            ((curAttr & CGA.HIGH) && !(attr & CGA.HIGH))) {
            str += '\x01N'
