...
say(
    `│ iCE Colors:    ${session.info.client.supportsIceColors ? "YES ✓" : "NO"}`.color(
        session.info.client.supportsIceColors ? "bright green" : "yellow"
    )
)
...
say(
    "  ▓▓".color("background bright black") +
        "  ".color("background bright red") +
        "  ".color("background bright green") +
        "  ".color("background bright yellow") +
        "  ".color("background bright blue") +
        "  ".color("background bright magenta") +
        "  ".color("background bright cyan") +
        "  ".color("background bright white")
)
say("")
...
say(
    `${session.supportsFonts() ? "✓" : "✗"} SyncTERM Font Switching:   ${session.supportsFonts() ? "ACTIVE" : "NOT SUPPORTED"}`.color(
        session.supportsFonts() ? "bright green" : "yellow"
    )
)
say(
    `${session.info.client.isSyncTerm ? "✓" : "✗"} Baud Rate Emulation:     ${session.info.client.isSyncTerm ? "ACTIVE" : "NOT SUPPORTED"}`.color(
        session.info.client.isSyncTerm ? "bright green" : "yellow"
    )
)
