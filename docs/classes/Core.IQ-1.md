...
- [`Iniquity`](Core.Iniquity.md)
  ...
  ↳↳ [`WFC`](core_src_modules_wfc.WFC.md)

  ↳↳ [`Apply`](templates_src_modules_eternity_apply.Apply.md)

  ↳↳ [`Login`](templates_src_modules_eternity_login.Login.md)
...
[packages/core/src/index.ts:567](https://github.com/iniquitybbs/iniquity/blob/a82cddc/packages/core/src/index.ts#L567)
