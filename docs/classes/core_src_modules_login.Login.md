...
- [encoding](core_src_modules_login.Login.md#encoding)
- [terminfo](core_src_modules_login.Login.md#terminfo)

### Methods

- [artwork](core_src_modules_login.Login.md#artwork)
- [ask](core_src_modules_login.Login.md#ask)
- [cursor](core_src_modules_login.Login.md#cursor)
- [disconnect](core_src_modules_login.Login.md#disconnect)
- [frame](core_src_modules_login.Login.md#frame)
- [gotoxy](core_src_modules_login.Login.md#gotoxy)
- [logoff](core_src_modules_login.Login.md#logoff)
- [logout](core_src_modules_login.Login.md#logout)
- [menu](core_src_modules_login.Login.md#menu)
- [pause](core_src_modules_login.Login.md#pause)
- [print](core_src_modules_login.Login.md#print)
- [say](core_src_modules_login.Login.md#say)
- [start](core_src_modules_login.Login.md#start)
- [user](core_src_modules_login.Login.md#user)
- [wait](core_src_modules_login.Login.md#wait)
...
[packages/core/src/modules/login.ts:20](https://github.com/iniquitybbs/iniquity/blob/dde6bbb/packages/core/src/modules/login.ts#L20)
